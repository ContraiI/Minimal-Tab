window.I18N_DATA = {
  'zh-CN': {
    ...
    ceUrl: '搜索 URL',
    ceIconDefault: '搜索引擎图标 (SVG/PNG/JPG/WebP)',
    btnCancel: '取消',
    btnAdd: '添加',
    btnUpdate: '更新',
    btnDelete: '删除',
    ...
    toastIconTooLarge: '图标文件过大：SVG 需小于 512KB，其他图片需小于 5MB',
    ...
    transErrTimeout: '请求超时，请检查网络后重试',
    transErrNetwork: '网络错误，请检查网络连接',
    transErrBadResponse: '接口返回异常，请稍后重试',
    transErrBusy: '服务繁忙或请求过于频繁，请稍后重试',
    transErrServer: '服务暂时不可用，请稍后重试',
    transErrRejected: '接口拒绝了请求，请检查密钥或参数设置',
    transErrAuth: '认证失败，请检查 SecretId/Key 是否正确',
    ...
    pageTransStyleTitle: '译文样式',
    pageTransFontColor: '字体颜色',
    pageTransLineColor: '边框颜色',
    pageTransItalic: '斜体',
    pageTransBold: '粗体',
    pageTransStyleNone: '无',
    pageTransStyleUnderlineA: '虚线下划线',
    pageTransStyleUnderlineB: '直线下划线',
  ...
  'en': {
    ...
    ceUrl: 'Search URL',
    ceIconDefault: 'Search Engine Icon (SVG/PNG/JPG/WebP)',
    btnCancel: 'Cancel',
    btnAdd: 'Add',
    btnUpdate: 'Update',
    btnDelete: 'Delete',
    ...
    backupIncludeSecrets: 'Include keys when exporting',
    ...
    toastIconTooLarge: 'Icon file too large: SVG must be under 512KB, other images under 5MB',
    ...
    transErrTimeout: 'Request timed out. Check your network and retry',
    transErrNetwork: 'Network error. Check your connection',
    transErrBadResponse: 'Unexpected API response. Retry later',
    transErrBusy: 'Service busy or rate limited. Retry later',
    transErrServer: 'Service temporarily unavailable. Retry later',
    transErrRejected: 'Request rejected. Check your key or settings',
    transErrAuth: 'Authentication failed. Check your SecretId/Key',
    ...
    pageTransStyleTitle: 'Translation Style',
    pageTransFontColor: 'Font Color',
    pageTransLineColor: 'Line Color',
    pageTransItalic: 'Italic',
    pageTransBold: 'Bold',
    pageTransStyleNone: 'None',
    pageTransStyleUnderlineA: 'Dashed Underline',
    pageTransStyleUnderlineB: 'Solid Underline',
